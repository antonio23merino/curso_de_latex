...
\usetheme{Madrid} % temas en http://deic.uab.es/~iblanes/beamer_gallerymetropolis/index_by_theme_and_color.html
\usepackage{latexsym}
...
\begin{figure}
\includegraphics[scale=0.2]{Imagenes/figura1.jpg}
...
\begin{figure}[t]
\centering
\includegraphics<1>[scale=0.5, angle=0]{Imagenes/figura1.jpg}
\includegraphics<2>[scale=0.5, angle=45]{Imagenes/figura1.jpg}
\includegraphics<3>[scale=0.5, angle=90]{Imagenes/figura1.jpg}
\includegraphics<4>[scale=0.5, angle=135]{Imagenes/figura1.jpg}
\includegraphics<5>[scale=0.5, angle=180]{Imagenes/figura1.jpg}
\includegraphics<6>[scale=0.5, angle=225]{Imagenes/figura1.jpg}
\includegraphics<7>[scale=0.5, angle=270]{Imagenes/figura1.jpg}
\includegraphics<8>[scale=0.5, angle=315]{Imagenes/figura1.jpg}
\includegraphics<9>[scale=0.5, angle=360]{Imagenes/figura1.jpg}
